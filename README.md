...
- **Jessie Yuen** - BCIT CST Student with an enthusiasm for arts and shopping.
...
- AI tools such as [ChatGPT](https://chatgpt.com/) were used for debugging, explanations, and code suggestions for portions of this project.
